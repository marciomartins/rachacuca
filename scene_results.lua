...
function scene:createScene( event )
  ...
  local result = "Parabéns,\nvocê conseguiu!"
 
  local resultsText = display.newText( result, 0, 0, native.systemFont, 32 )
  resultsText.x = display.contentCenterX
  resultsText.y = display.contentCenterY - 60
 
  group:insert( resultsText )
 
  local mainMenuButton = display.newText( "Novo jogo", 0, 0, native.systemFont, 18 )
